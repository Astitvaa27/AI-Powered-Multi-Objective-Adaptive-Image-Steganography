...
def main():
    ...
    # Source image number becomes the group.
    # Example:
    # 1127.pgm
    # 1127_stego_0.10bpp.pgm
    # Both belong to source group 1127.
    ...
    print("\n" + "=" * 75)
    print("BOSSBASE PAYLOAD DETECTION EXPERIMENT")
    print("=" * 75)

    # Same 80/20 source-group split for every payload.
